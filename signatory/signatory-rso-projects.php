  ...
  <div class="d-flex" id="wrapper">
    ...
    <!-- Page content
        <div class="col-lg-6 col-5 d-flex align-items-end justify-content-end">
          <a class="btn btn-secondary bg-secondary btn-circle button px-3 ms-2" href="admin-archive-projects.php" role="button"><i class="bi bi-archive-fill"></i> <span id="btntitle"> Project Archive</span></a>
        </div>-->
      </div>
      <div class="row ms-3 me-3 mt-2">
        <div class="col-lg-3 col-sm-6">
          <div class="card-counter primary">
            <div class="inner">
              <h3><?php
                  if ($data_signatorytype == 1) {
                    ...
                    $query = "SELECT COUNT(status) FROM tb_projectmonitoring WHERE status IN('Pending') AND approval_id = 1 AND org_id = '$orgid'";
                  } 
            ...
            <a href="signatory-rso-pending.php?id=<?= $orgid ?>" class="card-counter-footer">View More <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        ...
        <div class="col-lg-3 col-sm-6">
          <div class="card-counter success">
            <div class="inner">
              <h3><?php
                  if ($data_signatorytype == 1) {
                    ...
                    $query = "SELECT COUNT(status) FROM tb_projectmonitoring WHERE status IN('Approved') AND approval_id = 5 AND college_id = '$data_collegeid' AND org_id = '$orgid'";
                  } elseif ($data_signatorytype == 3) {
                    $query = "SELECT COUNT(status) FROM tb_projectmonitoring WHERE status IN('Approved') AND approval_id = 5 AND college_id = '$data_collegeid' AND org_id = '$orgid'";
                  } elseif ($data_signatorytype == 4) {
                    $query = "SELECT COUNT(status) FROM tb_projectmonitoring WHERE status IN('Approved') AND approval_id = 5 AND org_id = '$orgid'";
                  } 
                  $result = @mysqli_query($conn, $query);
                  $row = mysqli_fetch_array($result);
                  if ($row) {
            ...
            <a href="signatory-rso-approved.php?id=<?= $orgid ?>" class="card-counter-footer">View More <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        ...
        <div class="col-lg-3 col-sm-6">
          <div class="card-counter danger">
            <div class="inner">
              <h3><?php
                  if ($data_signatorytype == 1) {
                    ...
                    $query = "SELECT COUNT(status) FROM tb_projectmonitoring WHERE status IN('Rejected') AND college_id = '$data_collegeid' AND org_id = '$orgid'";
                  } elseif ($data_signatorytype == 3) {
                    $query = "SELECT COUNT(status) FROM tb_projectmonitoring WHERE status IN('Rejected') AND college_id = '$data_collegeid' AND org_id = '$orgid'";
                  } elseif ($data_signatorytype == 4) {
            ...
            <a href="signatory-rso-rejected.php?id=<?= $orgid ?>" class="card-counter-footer">View More <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        ...
        <div class="col-lg-3 col-sm-6">
          <div class="card-counter bg-secondary">
            <div class="inner">
              <h3><?php
                  if ($data_signatorytype == 1) {
                    ...
                    $query = "SELECT COUNT(status) FROM tb_projectmonitoring WHERE status IN('Reschedule') AND college_id = '$data_collegeid' AND org_id = '$orgid'";
            ...
            <a href="signatory-rso-reschedule.php?id=<?= $orgid ?>" class="card-counter-footer">View More <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
      ...
      <div class="row ms-3 me-3 mt-2">
        <div class="col-lg-3 col-sm-6">
          <div class="card-counter bg-info">
            <div class="inner">
              <h3><?php
                  if ($data_signatorytype == 1) {
                    ...
                    $query = "SELECT COUNT(status) FROM tb_projectmonitoring WHERE status IN('Ongoing') AND college_id = '$data_collegeid' AND org_id = '$orgid'";
                  }  elseif ($data_signatorytype == 3) {
                    $query = "SELECT COUNT(status) FROM tb_projectmonitoring WHERE status IN('Ongoing') AND college_id = '$data_collegeid' AND org_id = '$orgid'";
                  } elseif ($data_signatorytype == 4) {
            ...
            <a href="signatory-rso-ongoing.php?id=<?= $orgid ?>" class="card-counter-footer">View More <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <div class="col-lg-3 col-sm-6">
          <div class="card-counter done">
            <div class="inner">
              <h3><?php
                  if ( $data_signatorytype == 1) {
                    ...
                    $query = "SELECT COUNT(status) FROM tb_projectmonitoring WHERE status IN('Done') AND college_id = '$data_collegeid' AND org_id = '$orgid'";
                  } elseif ($data_signatorytype == 3) {
                    $query = "SELECT COUNT(status) FROM tb_projectmonitoring WHERE status IN('Done') AND college_id = '$data_collegeid' AND org_id = '$orgid'";
                  } elseif ($data_signatorytype == 4) {
            ...
            <a href="signatory-rso-done.php?id=<?= $orgid ?>" class="card-counter-footer">View More <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
          ...
          <div class="card-counter events">
            <div class="inner">
              <h3><?php
                    ...
                    $query = "SELECT COUNT(status) FROM tb_projectmonitoring WHERE status IN('For Revision') AND college_id = '$data_collegeid' AND org_id = '$orgid'";
                  } elseif ($data_signatorytype == 3) {
                    $query = "SELECT COUNT(status) FROM tb_projectmonitoring WHERE status IN('For Revision') AND college_id = '$data_collegeid' AND org_id = '$orgid'";
                  } elseif ($data_signatorytype == 4) {
                    $query = "SELECT COUNT(status) FROM tb_projectmonitoring WHERE status IN('For Revision') AND org_id = '$orgid'";
            ...
            <a href="signatory-rso-revision.php?id=<?= $orgid ?>" class="card-counter-footer">View More <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        ...
        <div class="col-lg-3 col-sm-6">
          <div class="card-counter masterlist">
            ...
            <a href="signatory-rso-masterlist.php?id=<?= $orgid ?>" class="card-counter-footer">View More <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
      </div>
