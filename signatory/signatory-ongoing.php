    ...
    <div id="content">
      ...
      <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active" id="active" aria-current="page"> <i class="bi bi-play-circle-fill"></i> Ongoing</li>
        </ol>
      </nav>
        ...
        <div class="table-responsive ms-0">
                <?php
                    if(isset($org_id) == NULL){
                      ...
                      $query = "SELECT * FROM tb_projectmonitoring WHERE status  IN('Ongoing') AND org_id = '$org_id'";
                    }
                    $result = @mysqli_query($conn,$query);
                    $i = 0;
                    $ds = " ";
