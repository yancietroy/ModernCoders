          ...
          <div class="row g-0 mt-4 justify-content-center">
            <div class="table-responsive ms-0">
              ...
              if ($data_signatorytype == 1) {
                ...
                $query = "SELECT * FROM tb_projectmonitoring WHERE status IN('Done') AND college_id = '$data_collegeid'";
              } elseif ($data_signatorytype == 3) {
                $query = "SELECT * FROM tb_projectmonitoring WHERE status IN('Done') AND college_id = '$data_collegeid'";
              } elseif ($data_signatorytype == 4) {
                $query = "SELECT * FROM tb_projectmonitoring WHERE status IN('Done') AND org_id = '$data_orgid'";
              }
