    ...
    <div id="content">
      ...
      <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active" id="active" aria-current="page"> <i class="bi bi-pencil-square"></i> For Revision</li>
        </ol>
      </nav>
      ...
      <div class="row ms-3 me-3 mt-2">
        <div class="col-lg-6 col-7">
          <h4>Signatory Projects For Revision List</h4>
        </div>
      </div>
        ...
        <div class="table-responsive ms-0">
                <?php
                  if(isset($org_id) == NULL && $stid == 2){
                    ...
                    $query = "SELECT * FROM tb_projectmonitoring WHERE status  IN('For Revision') AND org_id = '$org_id'";
                  }
                    $result = @mysqli_query($conn,$query);
                    $i = 0;
                    $ds = " ";
