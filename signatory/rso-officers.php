    ...
    <div id="content">
      ...
      <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item"><a href="rso.php"> <i class="bi bi-people-fill"></i> rso</a></li>
    ...
    <div class="modal-dialog" id="modal-lg" role="document">
        <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel"> View Officer Details </h5>
                       ...
                       <div class="form-outline">
                        ...
                        <div class="col-12 col-md-4 mb-4">
                            <div class="form-outline">
                              ...
                              <input id="birthdate" class="form-control birthdate" data-relmax="-18" min="1922-01-01" type="date" style="background-color: #fff;"  name="birthdate" onblur="getAge();" title="You should be over 18 years old"  readonly/>
                            </div>
                          </div>
                          <div class="col-12 col-md-4 mb-4">
                            <div class="form-outline">
