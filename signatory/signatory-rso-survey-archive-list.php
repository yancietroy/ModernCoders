    ...
    <div class="d-flex" id="wrapper">
        ...
        <script>
            $(document).on('click', '.viewbtn', function() {
                ...
                location.href = "signatory-rso-survey-archive-view.php?id=" + ORG_ID + "&survey_id=" + SURVEY_ID;
            });
            $(document).on('click', '.resultbtn', function() {
                var SURVEY_ID = $(this).attr("id");
                var ORG_ID = $('#org-id').val();
                console.log("signatory-rso-survey-archive-result.php?id=" + ORG_ID + "&survey_id=" + SURVEY_ID);
                location.href = "signatory-rso-survey-archive-result.php?id=" + ORG_ID + "&survey_id=" + SURVEY_ID;
            });
        </script>
        <!-- Datatable -->
