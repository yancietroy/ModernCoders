            ...
            <!-- <form class="was-validated"> -->
                ...
                <div class="row">
                  <div class="col-md-6 mb-4">
                    <div class="form-outline">
                      ...
                      <input type="text" id="age" class="form-control form-control-lg" required />
                      <div class="valid-feedback">Looks Good!</div>
                  ...
                  <div class="col-md-6 mb-4">
                    ...
                    <div class="form-check form-check-inline mb-0 me-4 ">
                      <input class="form-check-input" type="radio" name="gender" id="Male" autocomplete="off" />
                      <label class="form-check-label" for="femaleGender">Male</label>
                    </div>

                    <div class="form-check form-check-inline mb-0 me-4">
                      <input class="form-check-input" type="radio" name="gender" id="Female" autocomplete="off" />
                ...
                <div class="row">
                  ...
                  <div class="col-4 mb-4">
                    ...
                    <select class="form-select form-select-sm" s required>
                ...
                <div class="row">
                  ...
                  <div class="col-md-4 mb-4">
                    <div class="form-outline">
                      ...
                      <input type="text" class="form-control" id="password" data-bs-toggle="popover" data-bs-placement="bottom" title="Password Validation" minlength="8" data-bs-content="Must be at least 8 characters long &#013;
                Must contain at least one number &#013;
                  ...
                  <div class="col-md-4 mb-4">
                    <div class="form-outline">
                      ...
                      <input type="text" class="form-control" id="Confirmpassword" minlength="3" required>
                    </div>
                  </div>
                </div>

                <div class="col-md-12 mb-4">
                  <button class="w-100 btn btn-lg btn-primary mt-4" type="submit" value="register">Register</button>

                </div>

              </form>
              <hr class="my-4">
              <p class="mt-3 text-center">Already have an account? <a href="login.html" class="text-blue-50 fw-bold">Login</a>
              </p>
