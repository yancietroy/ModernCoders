...
$nav_breadcrumbs = [
    ...
    ["CSC Election", "", "bi bi-check2-square"],
];
            ...
            <div class="row ms-3 me-3 mt-2">
                <div class="col-lg-3 col-sm-6">
                    <div class="card-counter primary">
                        ...
                        <a href="election-active.php" class="card-counter-footer">Vote Now <i class="fa fa-arrow-circle-right"></i></a>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="card-counter success">
                        ...
                        <a href="election-results.php" class="card-counter-footer">View More <i class="fa fa-arrow-circle-right"></i></a>
                    </div>
                </div>
            </div>
