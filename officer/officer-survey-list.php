    ...
    <div class="d-flex" id="wrapper">
                    ...
                    <div class="row g-0 justify-content-center ">
                        <div class="table-responsive ms-2">
                            <table id='survey-table' class='py-3 display nowrap w-100 ms-0 stud'>
                                <thead>
                                    <tr>
                                        <th class="desktop">Survey Title</th>
                                ...
                                <tbody>
                                    <?php
                                    $sql = "SELECT * FROM tb_surveys ORDER BY survey_id DESC";
        ...
        <div class="modal fade" id="deletemodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form action="include/officer-archive-survey.php" method="POST">
        ...
        <script>
            $(document).on('click', '.viewbtn', function() {
                ...
                location.href = "officer-survey-view.php?id=" + SURVEY_ID;
            });
            ...
            $(document).on('click', '.resultbtn', function() {
                var SURVEY_ID = $(this).attr("id");
                location.href = "officer-survey-result.php?id=" + SURVEY_ID;
            });
        </script>
        <!-- Datatable -->
