...
$nav_breadcrumbs = [
  ...
  ["Org Profile", "", "bi bi-card-heading"],
];
                ...
                <div class="card-body mt-2 pt-0">
                  <table class="table table-bordered" id="proftable">
                    ...
                    <tr>
                      ...
                      <td width="2%">:</td>
                      <td><?php
                            $checkType = "SELECT org_type_id FROM tb_orgs WHERE ORG_ID = '$orgid' OR ORG_ID = '$data_orgid'";
                    ...
                    <tr>
                      ...
                      <td width="2%">:</td>
                      <td><?php
                            $query = "SELECT tb_collegedept.college FROM tb_orgs JOIN tb_collegedept ON tb_collegedept.college_id = tb_orgs.college_id WHERE tb_orgs.ORG_ID = '$orgid' OR tb_orgs.ORG_ID = '$data_orgid'";
                    ...
                    <tr>
                      ...
                      <td width="2%">:</td>
                      <td><?php
                            $query = "SELECT CONCAT(first_name, ' ', last_name) AS NAME FROM tb_signatories WHERE org_id = '$orgid' OR ORG_ID = '$data_orgid'";
                            $result = @mysqli_query($conn, $query);
                            $a = " ";
              ...
              <div class="row justify-content-between">
                ...
                <!--<div class="col-12 col-md-6 col-sm-3 mb-4">
                  <div class="form-outline">
                    ...
                    <select class="form-select" style="width:100%;" name="signatory_id" id="signatory_id"readonly>
