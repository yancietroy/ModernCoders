          ...
          <div class="modal-body">
            <div class="container-fluid">
              ...
              <div class="modal-footer px-0 py-0 pt-2">
                ...
                <button type="button" class="btn btn-md btn-outline-success" onclick="exportTableToCSV('budget-breakdown.csv')"><i class="bi bi-file-earmark-spreadsheet-fill"></i>
                  <span id="btntitle">Export Budget Request</span>
                </button>
