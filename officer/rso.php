            ...
            <div class="card-body p-4 mx-auto px-auto">
              <div class="row g-0 ">
                <div class="col-md-2 d-none d-sm-block text-center mt-3">
                  <img src="<?= getOrgLogo($orgid) ?>" class="rounded-circle img-fluid " alt="..." style="border: 2px solid #F2AC1B" width="122" height="150">
                </div>
                <div class='col-12 col-md-10 mt-4'>
                  <h3 class="justify-content-center align-items-center text-align-center"><?= $_SESSION['USER-ORG-NAME'] ?></h3>
                </div>
              </div>
      ...
      <div class="row justify-content-center mx-3">
        ...
        <div class="col-lg-3 col-sm-6 mb-4">
          <div class="card-counter bg-success">
            ...
            <a href="officer-election-index.php" class="card-counter-footer">View More <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <div class="col-lg-3 col-sm-6">
