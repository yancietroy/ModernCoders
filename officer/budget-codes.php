                ...
                while ($row = $result->fetch_assoc()) {
                  ...
                  echo "<tr>
                            ...
                            <button type='button' class='btn btn-success btn-sm viewbtn' id='" . $bi . "'> <i class='bi bi-list-ul'></i> </button>
                              <button type='button' class='btn btn-secondary btn-sm deletebtn' id='" . $bi . "'>  <i class='bi bi-archive-fill'></i>  </button>
                              </td>
                              </tr>
                          ";
                  /*
  ...
  <div class="modal fade" id="viewmodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" id="modal-lg" role="document">
      <div class="modal-content">
        ...
        <form action="officer-update-budget.php" method="POST">
