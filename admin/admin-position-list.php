...
$nav_breadcrumbs = [
  ...
  ["Election", "admin-election.php", "bi bi-check2-square"],
  ["Position List", "", "bi bi-person-badge-fill"],
];
    ...
    <div id="content">
      ...
      <div class="row ms-3 me-3 mt-2">
        ...
        <div class="col-lg-6 col-5 d-flex align-items-end justify-content-end">
          ...
          <a class="btn btn-secondary bg-secondary btn-circle button px-3 ms-2" href="admin-archive-position.php" role="button"><i class="bi bi-archive-fill"></i> <span id="btntitle"> Position Archive</span></a>
        </div>
      </div>
