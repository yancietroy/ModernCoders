    ...
    <div id="content">
      ...
      <div class="row ms-3 me-3 mt-2">
        <div class="col-lg-6 col-7">
          ...
          <a class="btn btn-default btn-circle button px-3" href="#" role="button"><i class="bi bi-plus-circle-fill"></i> <span id="btntitle">New Course </span></a>
            <a class="btn btn-secondary bg-secondary btn-circle button px-3 ms-2" href="#" role="button"><i class="bi bi-archive-fill"></i> <span id="btntitle">Archive Course</span></a>
        </div>
      </div>
