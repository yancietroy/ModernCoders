...
<body>
        ...
        <div class="card-body px-2 mx-3 py-3 pt-4 ">
          <div class="row g-0 justify-content-center ">
            <div class="table-responsive ms-2">
              <?php
              $query = "SELECT * FROM tb_collegedept_archive";
              ...
              <div class="row justify-content-between">
                ...
                <div class="col-12 col-md-6 mb-4">
                  <div class="form-outline">
                    ...
                    <input type="text" name="college" id="college" class="form-control" onkeypress="return /[a-z, ,-]/i.test(event.key)" style="background-color: #fff;" maxlength="100" readonly />
                  </div>
                </div>
              </div>
            </div>
  ...
  <script>
    $(document).on('click', '.viewbtn', function() {
      ...
      $.ajax({
        url: "admin-fetch-college-archive.php",
        method: "POST",
        data: {
