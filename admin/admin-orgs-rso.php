      ...
      <div class="row ms-3 me-3">
        <div class="col-lg-3 col-sm-6">
          <div class="card-counter primary">
            ...
            <a href="admin-orgs-rso-members.php?id=<?= $orgid ?>" class="card-counter-footer">View More <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <div class="col-lg-3 col-sm-6">
          <div class="card-counter bg-warning">
            ...
            <a href="admin-orgs-rso-officers.php?id=<?= $orgid ?>" class="card-counter-footer">View More <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <div class="col-lg-3 col-sm-6">
          <div class="card-counter bg-info">
            ...
            <a href="admin-orgs-rso-signatories.php?id=<?= $orgid ?>" class="card-counter-footer">View More <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        ...
        <div class="col-lg-3 col-sm-6">
          <div class="card-counter bg-danger">
            ...
            <a href="admin-survey.php?id=<?= $orgid ?>" class="card-counter-footer">View More <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        ...
        <div class="col-lg-3 col-sm-6 mb-4">
          <div class="card-counter bg-success">
            ...
            <a href="admin-projects.php?id=<?= $orgid ?>" class="card-counter-footer">View More <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <div class="col-lg-3 col-sm-6">
