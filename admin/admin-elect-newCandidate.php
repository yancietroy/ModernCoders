    ...
    <div id="content">
      ...
      <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active" id="active" aria-current="page">   <i class="bi bi-person-lines-fill"></i> Positions</li>
        </ol>
      </nav>
          ...
          <div class="card-body px-5 py-3 pt-4 ">
            <div class="row g-0 justify-content-center align-items-center ">
                    <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" id="form" name="form" data-parsley-validate data-parsley-trigger="keyup" data-parsley-validate class="requires-validation" novalidate>
                                    <h3 class="mb-4 pb-2 pb-md-0 mb-md-5 text-center">Candidate Form</h3>

                                    <!-- <form class="was-validated"> -->
                                    <div class="row justify-content-between">
                                    <div class="col-12 col-md-4  mb-4">
                                      <div class="form-outline">
                                        <label class="form-label" for="STUDENT_NO" id="asterisk">Student ID</label>
                                        <input type="text" name="STUDENT_NO" id="STUDENT_NO" class="form-control" placeholder="##-###### " required />
                                  ...
                                  <div class="row justify-content-between">
                                    <div class="col-12 col-md-6 col-sm-3 mb-4">
                                      <div class="form-outline">
                                        <label class="form-label" for="FIRST_NAME" id="asterisk">First name</label>
                                        <input type="text" name="FIRST_NAME" onkeypress="return /[a-z, ,-]/i.test(event.key)" pattern="^(?:[A-Za-z]+[ -])*[A-Za-z]+$" maxlength="20" id="FIRST_NAME" class="form-control form-control-lg" required="" />
                                        <div class="valid-feedback"></div>
                                    ...
                                    <div class="col-12 col-md-6  mb-4">
                                      <div class="form-outline">
                                        ...
                                        <input type="text" name="LAST_NAME"  onkeypress="return /[a-z, ,-]/i.test(event.key)" pattern="^(?:[A-Za-z]+[ -])*[A-Za-z]+$" maxlength="20" id="LAST_NAME" class="form-control form-control-lg" required="" />
                                        <div class="valid-feedback"> </div>
                                    ...
                                    <?php
                                if (isset($so) || isset($fn) || isset($ln) || isset($s) || isset($orgid) || isset($posid) || isset($_POST['submit']))
                                  {
                                    $so = $_POST['STUDENT_NO'];
                                    $fn = $_POST['FIRST_NAME'];
                                    $ln = $_POST['LAST_NAME'];
                                    ...
                                    $duplicate=mysqli_query($conn,"SELECT * FROM tb_candidate WHERE STUDENT_NO='$so'");
                                    ...
                                    $sql = "INSERT INTO tb_candidate(STUDENT_NO, FIRST_NAME, LAST_NAME, section, ORG_ID, POSITION_ID) VALUES('$so', '$fn', '$ln', '$s', '$orgid', '$posid')";
                                    $conn->exec($sql);
                                    echo "<script type='text/javascript'>
                                        Swal.fire({
                                             icon: 'success',
