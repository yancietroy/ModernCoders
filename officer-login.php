            ...
            <form method="POST" class="requires-validation" novalidate autocomplete="off">
              ...
              if (isset($_POST['submit'])) {
                ...
                if (!empty($_POST['email']) || !empty($_POST['password'])) {
                  ...
                  $query = "SELECT officer_ID,org_id,first_name,last_name,position_id,student_id,college_dept FROM tb_officers WHERE EMAIL='$e' AND PASSWORD=SHA('$p')";
              ...
              <div class="form-outline mb-2">
                <select class="selectpicker form-select mt-2 py-3" id="select-opt">
                  <option class="greyclr" selected disabled value="" text-muted>Officer</option>
