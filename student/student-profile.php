                ...
                <div class="card-body mt-2 pt-0">
                  <table class="table table-bordered" id="proftable">
                    ...
                    <tr>
                      ...
                      <td width="2%">:</td>
                      <td><?php $query = "SELECT tb_students.COLLEGE_DEPT, tb_collegedept.college FROM tb_students INNER JOIN tb_collegedept ON tb_students.COLLEGE_DEPT=tb_collegedept.college_id WHERE tb_students.STUDENT_ID = '$data_userid'";
                          $result = @mysqli_query($conn, $query);
                    ...
                    <tr>
                      <th width="30%">Role </th>
                      <td width="2%">:</td>
                      <td><?php $query = "SELECT tb_students.USER_TYPE, tb_usertypes.user_type FROM tb_students INNER JOIN tb_usertypes ON tb_students.USER_TYPE=tb_usertypes.usertype_id WHERE tb_students.STUDENT_ID = '$data_userid'";
                          $result = @mysqli_query($conn, $query);
                          $row = @mysqli_fetch_array($result);
                          if ($row) {
                            echo "$row[user_type]";
                    ...
                    <!--  <tr>
                      ...
                      <td width="2%">:</td>
                      <td><1? php/* $query = "SELECT tb_students.position_id, tb_position.position FROM tb_students INNER JOIN tb_position ON tb_students.position_id=tb_position.POSITION_ID WHERE tb_students.STUDENT_ID = '$officer_id'";
                                $result = @mysqli_query($conn, $query);
                  ...
                  <div class="card-body mt-2 p-0 pt-0" id="card-show">
                    ...
                    <p class="mb-2 pe-2"><strong class="pr-1 text-muted ">College:<br></strong><?php $query = "SELECT tb_students.COLLEGE_DEPT, tb_collegedept.college FROM tb_students INNER JOIN tb_collegedept ON tb_students.COLLEGE_DEPT=tb_collegedept.college_id WHERE tb_students.STUDENT_ID = '$data_userid'";
                                                                                                $result = @mysqli_query($conn, $query);
                                                                                                $row = @mysqli_fetch_array($result);
                                                                                                if ($row) {
                                                                                                  echo "$row[college]";
