...
<body>
  <div class="d-flex" id="wrapper">
          ...
          <div class="modal-dialog modal-dialog-centered">
              <div class="modal-content rounded-0">
                  ...
                  <div class="modal-body rounded-0">
                      <div class="container-fluid">
                          <dl>
                              <dt class="text-muted">project_name</dt>
                              <dd id="project_name" class="fw-bold fs-4"></dd>
                              <dt class="text-muted">project_desc</dt>
    ...
    <?php
    $schedules = $conn->query("SELECT * FROM `tb_projectmonitoring` WHERE status='Pending' OR status='Ongoing'");
    $sched_res = [];
