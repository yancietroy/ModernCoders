    ...
    <div id="content">
      ...
      <div class="row ms-3 me-3 mt-2">
        <div class="col-lg-6 col-7">
          <h4 id="orgtitle"><?= $orgName ?> Election</h4>
        </div>
      </div>
      <div class="row ms-3 me-3 mt-2">
        <div class="col-lg-3 col-sm-6">
          <div class="card-counter primary">
            ...
            <a href="election-active.php?id=<?= $orgid ?>" class="card-counter-footer">Vote Now <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        ...
        <div class="col-lg-3 col-sm-6">
          <div class="card-counter success">
            ...
            <a href="election-results.php?id=<?= $orgid ?>" class="card-counter-footer">View More <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
      </div>
