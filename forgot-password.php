...
if (isset($_POST['$student_email']) || isset($_POST['submit'])) {
                  ...
                  $body = "Kindly change your password using the link below:<br><b><a href='https://jrusop.com/new-password.php?email=$student_email'>CHANGE PASSWORD</a></b>"; // Body/Message of the email
