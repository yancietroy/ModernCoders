...
!function(t, e) {
  ...
  : "function" == typeof define && define.amd
          ...
          h =
              t => {
                ...
                if (t.style && t.parentNode && t.parentNode.style) {
                  ...
                  return "none" !== e.display && "none" !== i.display &&
                         "hidden" !== e.visibility
                }
                return !1
              },
          u = t => !t || t.nodeType !== Node.ELEMENT_NODE ||
    ...
    function j(t, e, i, n, s) {
      ...
      const [o, r, a] = I(e, i, n), l = N(t), c = l[a] || (l[a] = {}),
                   d = S(c, r, o ? i : null);
      if (d)
        ...
        return function n(s) {
          ...
          for (let {target : r} = s; r && r !== this; r = r.parentNode)
            for (let a = o.length; a--;)
              if (o[a] === r)
                return s.delegateTarget = r, n.oneOff && H.off(t, s.type, e, i),
                       i.apply(r, [ s ]);
          return null
        }
      }(t, i, n) : function(t, e) {
        return function i(n) {
          return n.delegateTarget = t, i.oneOff && H.off(t, n.type, e),
                 e.apply(t, [ n ])
        }
      }(t, i);
      u.delegationSelector = o ? i : null, u.originalHandler = r, u.oneOff = s,
      u.uidEvent = h, c[h] = u, t.addEventListener(a, u, o)
    }
                 ...
                 : h = new CustomEvent(e, {bubbles : l, cancelable : !0}),
                   void 0 !== i &&
                       Object.keys(i).forEach(t => {Object.defineProperty(
                                                  h, t, {get : () => i[t]})}),
                   d && h.preventDefault(), c && t.dispatchEvent(h),
                   h.defaultPrevented && void 0 !== a && a.preventDefault(), h
      }
    };
    class R {
      constructor(t) {
    ...
    H.on(document, "click.bs.alert.data-api", '[data-bs-dismiss="alert"]',
    ...
    class Q extends R {
      ...
      _addTouchEventListeners() {
        ...
        t.find(".carousel-item img", this._element)
            .forEach(t => {H.on(t, "dragstart.bs.carousel",
                                t => t.preventDefault())}),
            this._pointerEvent
      ...
      _keydown(t) {
        /input|textarea/i.test(t.target.tagName) ||
            ("ArrowLeft" === t.key ? (t.preventDefault(), this._slide(Y))
                                   : "ArrowRight" === t.key &&
      ...
      _getItemByOrder(t, e) {
        const i = t === V, n = t === K, s = this._getItemIndex(e),
      ...
      _slide(e, i) {
        const n = this._directionToOrder(e),
              ...
              c = n === V, d = c ? "carousel-item-start" : "carousel-item-end",
        ...
        if (this._element.classList.contains("slide")) {
          ...
          const t = () => {
            r.classList.remove(d, h), r.classList.add("active"),
                s.classList.remove("active", h, d), this._isSliding = !1,
                                                    setTimeout(f, 0)
          };
      ...
      _directionToOrder(t) {
        return [ Y, X ].includes(t) ? _()       ? t === X ? K : V
                                      : t === X ? V
                                                : K
                                    : t
      }
      _orderToDirection(t) {
        return [ V, K ].includes(t) ? _()       ? t === K ? X : Y
                                      : t === K ? Y
                                                : X
                                    : t
      }
      ...
      static jQueryInterface(t) {
        return this.each((function() { Q.carouselInterface(this, t) }))
      }
      static dataApiClickHandler(t) {
        ...
        n && (i.interval = !1), Q.carouselInterface(e, i),
            n && w.get(e, "bs.carousel").to(n), t.preventDefault()
      }
    }
    H.on(document, "click.bs.carousel.data-api",
         "[data-bs-slide], [data-bs-slide-to]", Q.dataApiClickHandler),
    ...
    class J extends R {
      ...
      hide() {
        ...
        m(this._element), this._element.classList.add("collapsing"),
      ...
      _getConfig(t) {
        return (t = {...G, ...t}).toggle = Boolean(t.toggle),
                           d("collapse", t, Z), t
      }
      _getDimension() {
      ...
      static jQueryInterface(t) {
        return this.each((function() { J.collapseInterface(this, t) }))
      }
    }
    H.on(document, "click.bs.collapse.data-api", '[data-bs-toggle="collapse"]',
        ...
        b(J);
    var tt = "top", et = "bottom", it = "right", nt = "left",
        st = [ tt, et, it, nt ],
    ...
    var Nt = {
      ...
      fn : function(t) {
        var e, i = t.state, n = t.name, s = t.options, o = i.elements.arrow,
               r = i.modifiersData.popperOffsets, a = pt(i.placement),
               l = At(a), c = [ nt, it ].indexOf(a) >= 0 ? "height" : "width";
        if (o && r) {
          var d =
                  function(t, e) {
            return xt("number" !=
              ...
              h = gt(o), u = "y" === l ? tt : nt, f = "y" === l ? et : it,
              p = i.rects.reference[c] + i.rects.reference[l] - r[l] -
                  i.rects.popper[c],
              m = r[l] - i.rects.reference[l], g = Tt(o),
              _ = g ? "y" === l ? g.clientHeight || 0 : g.clientWidth || 0 : 0,
              b = p / 2 - m / 2, v = d[u], y = _ - h[c] - d[f],
              w = _ / 2 - h[c] / 2 + b, E = Ct(v, w, y), T = l;
      ...
      effect : function(t) {
        ...
        null != n &&
            ...
            _t(e.elements.popper, n) && (e.elements.arrow = n)
      },
    ...
    function It(t) {
      var e,i=t.popper,n=t.popperRect,s=t.placement,o=t.offsets,r=t.position,a=t.gpuAcceleration,l=t.adaptive,c=t.roundOffsets,d=!0===c?function(t){var e=t.x,i=t.y,n=window.devicePixelRatio||1;return{x:kt(kt(e*n)/n)||0,y:kt(kt(i*n)/n)||0}}(o):"function"==typeof c?c(o):o,h=d.x,u=void 0===h?0:h,f=d.y,p=void 0===f?0:f,m=o.hasOwnProperty("x"),g=o.hasOwnProperty("y"),_=nt,b=tt,v=window;
      if (l) {
        var y = Tt(i), w = "clientHeight", E = "clientWidth";
        y === ct(i) && "static" !== bt(y = yt(i)).position &&
            (w = "scrollHeight", E = "scrollWidth"),
            y = y, s === tt && (b = et, p -= y[w] - n.height, p *= a ? 1 : -1),
    ...
    var jt = {
      ...
      fn : function(t) {
        ...
        null != e.modifiersData.popperOffsets &&
            (e.styles.popper =
                 Object.assign({}, e.styles.popper, It(Object.assign({}, c, {
            ...
            null != e.modifiersData.arrow &&
                (e.styles.arrow =
                     Object.assign({}, e.styles.arrow, It(Object.assign({}, c, {
        ...
        Pt = {passive : !0}, Mt = {
          ...
          effect : function(t) {
            ...
            return o && c.forEach((function(
                            t) { t.addEventListener("scroll", i.update, Pt) })),
    ...
    function Rt(t) {
      return t.replace(/left|right|bottom|top/g, (function(t) { return Ht[t] }))
    }
    var Bt = {start : "end", end : "start"};
    function Wt(t) {
      return t.replace(/start|end/g, (function(t) { return Bt[t] }))
    }
    function qt(t) {
      var e = ct(t);
    ...
    function Yt(t, e) {
      ...
      var i = e, n = i.placement, s = void 0 === n ? t.placement : n,
          ...
          c = i.elementContext, d = void 0 === c ? "popper" : c,
          h = i.altBoundary, u = void 0 !== h && h, f = i.padding,
          p = void 0 === f ? 0 : f,
          m = xt("number" != typeof p ? p : Dt(p, st)),
          g = "popper" === d ? "reference" : "popper", _ = t.elements.reference,
          b = t.rects.popper, v = t.elements[u ? g : d],
          y =
              function(t, e, i) {
            var n="clippingParents"===e?function(t){var e=$t(wt(t)),i=["absolute","fixed"].indexOf(bt(t).position)>=0&&ht(t)?Tt(t):t;return dt(i)?e.filter((function(t){return dt(t)&&_t(t,i)&&"body"!==lt(t)})):[]}(t):[].concat(e),s=[].concat(n,[i]),o=s[0],r=s.reduce((function(e,i){var n=Vt(t,i);return e.top=Lt(n.top,e.top),e.right=Ot(n.right,e.right),e.bottom=Ot(n.bottom,e.bottom),e.left=Lt(n.left,e.left),e}),Vt(t,o));
      ...
      fn : function(t) {
        ...
        if (!e.modifiersData[n]._skip) {
          for(var s=i.mainAxis,o=void 0===s||s,r=i.altAxis,a=void 0===r||r,l=i.fallbackPlacements,c=i.padding,d=i.boundary,h=i.rootBoundary,u=i.altBoundary,f=i.flipVariations,p=void 0===f||f,m=i.allowedAutoPlacements,g=e.options.placement,_=pt(g),b=l||(_!==g&&p?function(t){if("auto"===pt(t))return[];var e=Rt(t);return[Wt(t),e,Wt(e)]}(g):[Rt(g)]),v=[g].concat(b).reduce((function(t,i){return t.concat("auto"===pt(i)?Qt(e,{placement:i,boundary:d,rootBoundary:h,padding:c,flipVariations:p,allowedAutoPlacements:m}):i)}),[]),y=e.rects.reference,w=e.rects.popper,E=new Map,T=!0,A=v[0],L=0;L<v.length;L++){
            var O = v[L], k = pt(O), C = "start" === Kt(O),
                x = [ tt, et ].indexOf(k) >= 0, D = x ? "width" : "height",
                N = Yt(e, {
                  placement : O,
                  boundary : d,
                  rootBoundary : h,
            ...
            y[D] > w[D] && (S = Rt(S));
            var I = Rt(S), j = [];
            if (o && j.push(N[k] <= 0), a && j.push(N[S] <= 0, N[I] <= 0),
    ...
    function Jt(t) {
      return [ tt, it, et, nt ].some((function(e) { return t[e] >= 0 }))
    }
    var te = {
      name : "hide",
      enabled : !0,
      ...
      fn : function(t) {
        var e = t.state, i = t.name, n = e.rects.reference, s = e.rects.popper,
            ...
            a = Yt(e, {altBoundary : !0}), l = Zt(r, n), c = Zt(a, s, o),
            d = Jt(l), h = Jt(c);
        e.modifiersData[i] = {
        ...
        ne = {
          ...
          fn : function(t) {
            var e = t.state, i = t.options, n = t.name, s = i.mainAxis,
                ...
                l = i.boundary, c = i.rootBoundary, d = i.altBoundary,
                h = i.padding, u = i.tether, f = void 0 === u || u,
            ...
            if (E) {
              if (o || a) {
                var k = "y" === y ? tt : nt, C = "y" === y ? et : it,
                    ...
                    N = E[y] + g[k], S = E[y] - g[C], I = f ? -A[x] / 2 : 0,
                    j = "start" === b ? T[x] : A[x],
                    ...
                    F = $ ? "y" === y ? $.clientTop || 0 : $.clientLeft || 0
                          : 0,
                ...
                if (a) {
                  var Q = "x" === y ? tt : nt, G = "x" === y ? et : it,
                      Z = E[w], J = Z + g[Q], st = Z - g[G],
                 ...
                 (("body" !== lt(e) || Ut(o)) &&
                      (l = (n = e) !== ct(n) && ht(n) ? {
                        ...
                        scrollTop : s.scrollTop
                                                      ...
                                                      : qt(n)),
                  ht(e) ? ((c = mt(e)).x += e.clientLeft, c.y += e.clientTop)
                        : o && (c.x = zt(o))),
      {
    ...
    function ae(t) {
      ...
      var e = t, i = e.defaultModifiers, n = void 0 === i ? [] : i,
          s = e.defaultOptions, o = void 0 === s ? oe : s;
      return function(t, e, i) {
        ...
        var s, r,
            ...
            l = [], c = !1, d = {
              ...
              setOptions : function(i) {
                h(), a.options = Object.assign({}, o, a.options, i),
                     a.scrollParents = {
                       reference : dt(t)              ? $t(t)
                                   : t.contextElement ? $t(t.contextElement)
                                                      : [],
                       popper : $t(e)
                     };
                var s, r,
        ...
        return d.setOptions(i).then((function(
    ...
    class we extends R {
      ...
      _addEventListeners() {
        H.on(this._element, "click.bs.dropdown",
      ...
      static jQueryInterface(t) {
        return this.each((function() { we.dropdownInterface(this, t) }))
      }
      static clearMenus(e) {
      ...
      static dataApiKeydownHandler(e) {
        ...
        i || "ArrowUp" !== e.key && "ArrowDown" !== e.key
            ? i && "Space" !== e.key ? we.getInstance(n())._selectMenuItem(e)
                                     : we.clearMenus()
            : n().click()
      }
    }
    H.on(document, "keydown.bs.dropdown.data-api",
         '[data-bs-toggle="dropdown"]', we.dataApiKeydownHandler),
        ...
        H.on(document, "click.bs.dropdown.data-api",
             ...
             (function(t) { t.preventDefault(), we.dropdownInterface(this) })),
        b(we);
    const Ee =
        () => {
          ...
          Oe =
              () => {
                ke("body", "overflow"), ke("body", "paddingRight"),
          ...
          ke =
              (e, i) => {
                t.find(e).forEach(t => {
                  ...
                  void 0 === e ? t.style.removeProperty(i)
    ...
    class De {
      ...
      show(t) {
        this._config.isVisible
            ? (this._append(), this._config.isAnimated && m(this._getElement()),
      ...
      _getConfig(t) {
        return (t = {...Ce, ..."object" == typeof t ? t : {}}).rootElement =
    ...
    const Ne = {backdrop : !0, keyboard : !0, focus : !0}, Se = {
    ...
    class Ie extends R {
      ...
      hide(t) {
        ...
        e && (this._isTransitioning = !0), this._setEscapeEvent(),
            this._setResizeEvent(), H.off(document, "focusin.bs.modal"),
            this._element.classList.remove("show"),
      ...
      _getConfig(t) {
        return t = {...Ne, ...U.getDataAttributes(this._element), ...t},
               d("modal", t, Se), t
      }
      _showElement(e) {
        ...
        this._element.parentNode &&
            ...
            i && m(this._element), this._element.classList.add("show"),
      ...
      _enforceFocus() {
        H.off(document, "focusin.bs.modal"),
            H.on(document, "focusin.bs.modal",
      ...
      _setEscapeEvent() {
        this._isShown
            ? H.on(this._element, "keydown.dismiss.bs.modal",
    ...
    class Me extends R {
      ...
      hide() {
        this._isShown &&
            (H.trigger(this._element, "hide.bs.offcanvas").defaultPrevented ||
             (H.off(document, "focusin.bs.offcanvas"), this._element.blur(),
      ...
      _enforceFocusOnElement(t) {
        H.off(document, "focusin.bs.offcanvas"),
            H.on(document, "focusin.bs.offcanvas",
                 e => {document === e.target || t === e.target ||
                       t.contains(e.target) || t.focus()}),
            t.focus()
      }
      _addEventListeners() {
        H.on(this._element, "click.dismiss.bs.offcanvas",
             '[data-bs-dismiss="offcanvas"]', () => this.hide()),
            H.on(this._element, "keydown.dismiss.bs.offcanvas",
                 t => {this._config.keyboard && "Escape" === t.key &&
                       this.hide()})
      }
      static jQueryInterface(t) {
        return this.each((function() {
          const e = w.get(this, "bs.offcanvas") ||
    ...
    H.on(document, "click.bs.offcanvas.data-api",
        ...
        H.on(window, "load.bs.offcanvas.data-api",
             () => {
                 t.find(".offcanvas.show")
                     .forEach(
                         t => (w.get(t, "bs.offcanvas") || new Me(t)).show())}),
        b(Me);
    const He = new Set([
    ...
    class Xe extends R {
      ...
      hide() {
        ...
        this._queueCallback(
            () => {this._isWithActiveTrigger() ||
                   ("show" !== this._hoverState && t.parentNode &&
      ...
      _initializeOnDelegatedTarget(t, e) {
        ...
        return (e = e || w.get(t.delegateTarget, i)) ||
      ...
      _getConfig(t) {
        ...
        return Object.keys(e).forEach(t => {Ue.has(t) && delete e[t]}),
               (t = {
                 ...this.constructor.Default,
                 ...e,
                 ..."object" == typeof t && t ? t : {}
    ...
    b(Je);
    const ti = {offset : 10, method : "auto", target : ""}, ei = {
      offset : "number",
      method : "string",
    ...
    class ni extends R {
      ...
      show() {
        ...
        const o =
            e ? H.trigger(e, "hide.bs.tab", {relatedTarget : this._element})
              : null;
      ...
      _transitionComplete(e, i, n) {
        ...
        e.classList.add("active"),
            ...
            m(e), e.classList.contains("fade") && e.classList.add("show");
        let s = e.parentNode;
    ...
    class ri extends R {
      ...
      show() {
        H.trigger(this._element, "show.bs.toast").defaultPrevented ||
            (this._clearTimeout(),
             ...
             this._element.classList.remove("hide"), m(this._element),
      ...
      _setListeners() {
        H.on(this._element, "click.dismiss.bs.toast",
    ...
    return b(ri), {
      Alert: B, Button: W, Carousel: Q, Collapse: J, Dropdown: we, Modal: Ie,
          Offcanvas: Me, Popover: Je, ScrollSpy: ii, Tab: ni, Toast: ri,
          Tooltip: Xe
    }
  }));
